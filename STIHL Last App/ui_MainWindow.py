...
class Ui_Main(object):
    ...
    def setupUi(self, Main):
        ...
        Main.setMinimumSize(QSize(width_display / 1.53, height_display / 1.53))
        ...
        self.centralwidget.setMinimumSize(QSize(width_display / 1.53, height_display / 1.53))
        ...
        self.topbar_menu.setMinimumSize(QSize(width_display / 160, height_display / 12.10))
        ...
        self.slideMenuFrame.setMinimumSize(QSize(width_display / 20.5, height_display / 11.25))
        ...
        self.horizontalLayout_3.setSpacing(height_display / 360)
        self.horizontalLayout_3.setObjectName(u"horizontalLayout_3")
        self.horizontalLayout_3.setContentsMargins(width_display / 355.55, height_display / 300, height_display / 300,
                                                   height_display / 300)
        self.slideMenuButton = QPushButton(self.slideMenuFrame)
        self.slideMenuButton.setObjectName(u"slideMenuButton")
        self.slideMenuButton.setMinimumSize(QSize(width_display / 20.7, height_display / 18))
        ...
        self.slideMenuButton.setIconSize(QSize(height_display / 25.7, height_display / 25.7))
        ...
        self.minimazeButton.setMinimumSize(QSize(height_display / 20, height_display / 20))
        ...
        self.minimazeButton.setIconSize(QSize(height_display / 43.9, height_display / 43.9))
        ...
        self.maximazeButton.setMinimumSize(QSize(height_display / 18.9, height_display / 18.9))
        ...
        self.maximazeButton.setIconSize(QSize(height_display / 32.14, height_display / 32.14))

        self.horizontalLayout.addWidget(self.maximazeButton)

        self.closeButton = QPushButton(self.window_buttons)
        self.closeButton.setObjectName(u"closeButton")
        self.closeButton.setMinimumSize(QSize(height_display / 18, height_display / 18))
        ...
        self.closeButton.setIconSize(QSize(height_display / 34.61, height_display / 34.61))
        ...
        self.left_side_menu.setMinimumSize(QSize(width_display / 18.82, 0))
        self.left_side_menu.setMaximumSize(QSize(width_display / 18.82, 16777215))
        ...
        self.verticalLayout_2.setSpacing(height_display / 32)
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.verticalLayout_2.setContentsMargins(0, height_display / 64.28, 0, height_display / 90)
        ...
        self.homeButton.setIconSize(QSize(height_display / 20.45, height_display / 20.45))
        ...
        self.listButton.setIconSize(QSize(height_display / 21.17, height_display / 21.17))
        ...
        self.addButton.setIconSize(QSize(height_display / 21.17, height_display / 21.17))
        ...
        self.removeButton.setIconSize(QSize(height_display / 21.17, height_display / 21.17))

        self.verticalLayout_2.addWidget(self.removeButton)

        self.chooseTablePushButton = QPushButton(self.left_menu_buttons)
        self.chooseTablePushButton.setObjectName(u"chooseTablePushButton")
        self.chooseTablePushButton.setCursor(QCursor(Qt.PointingHandCursor))
        self.chooseTablePushButton.setStyleSheet(u"margin-left: 0%;")
        icon8 = QIcon()
        icon8.addFile(u":/Icons/Icons/DataChoice.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.chooseTablePushButton.setIcon(icon8)
        self.chooseTablePushButton.setIconSize(QSize(height_display / 21.17, height_display / 21.17))

        self.verticalLayout_2.addWidget(self.chooseTablePushButton)
        ...
        self.footer.setMinimumSize(QSize(0, height_display / 45))
        self.footer.setMaximumSize(QSize(16777215, height_display / 45))
        ...
        self.size_grip.setMinimumSize(QSize(width_display / 80, height_display / 60))
        ...
        self.containerPages = StackedWidget(self.content_menu)
        ...
        self.creationDateLineEdit = QLineEdit(self.ClientViewFrame)
        self.creationDateLineEdit.setReadOnly(True)
        self.creationDateLineEdit.setObjectName(u"creationDateLineEdit")
        self.creationDateLineEdit.setStyleSheet(u"	font: 12pt \"Bahnschript\";\n"
                                                "	font-style: italic;\n"
                                                "	color: white;")
        self.creationDateLineEdit.setAlignment(Qt.AlignCenter)

        self.gridLayout_4.addWidget(self.creationDateLineEdit, 0, 3, 1, 1)
        ...
        self.expirationDateLineEdit.setReadOnly(True)
        ...
        self.Valid_InvalidLabel.setStyleSheet(u"font: 30pt \"Bahnschript\";\n"
                                              "font-style: italic;\n"
                                              "color: white;")
        ...
        self.PrintButton.setMinimumSize(QSize(width_display / 17.77, height_display / 11))
        ...
        self.addPushBUtton.setMinimumSize(QSize(0, height_display / 60))
        font10 = QFont()
        ...
        self.quitPushButton.setMinimumSize(QSize(0, height_display / 60))
        ...
        self.removePushButton.setMinimumSize(QSize(0, height_display / 52.94))
        ...
        self.quitPushButton_2.setMinimumSize(QSize(0, height_display / 52.94))
    ...
    def retranslateUi(self, Main):
        ...
        self.titleLabel.setText(
            QCoreApplication.translate("Main", u"<html><head/><body><p>STIHL Client Register</p></body></html>", None))
        self.minimazeButton.setText("")
        self.maximazeButton.setText("")
        self.closeButton.setText("")

        self.versionLabel.setText(QCoreApplication.translate("Main", u"v 1.3", None))
